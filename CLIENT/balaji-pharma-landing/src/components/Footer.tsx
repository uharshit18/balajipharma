         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
               ...
               <div>
                  ...
                  <ul className="space-y-3 text-sm">
                     <li>B-6, Fateh Tower, Nagori Garden</li>
            ...
            <div className="border-t border-slate-800 pt-8 text-center text-slate-500 text-sm">
               <p>&copy; {new Date().getFullYear()} Balaji Pharma. All rights reserved.
                  ...
                  <Link to="/privacy-policy" className="hover:text-white mx-2 block md:inline">Privacy Policy</Link>
                  <span className="mx-2 hidden md:inline">|</span>
                  <Link to="/terms-of-service" className="hover:text-white mx-2 block md:inline">Terms of Service</Link>
               </p>
