                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="w-full md:w-1/2">
                            <div className="bg-white p-8 rounded-2xl shadow-xl">
                                <h3 className="text-2xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                                    <MapPin className="text-red-500" /> Coverage Area
                                </h3>
                                <div className="space-y-4">
                                    <div className="flex items-start gap-4 p-4 bg-slate-50 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-600">Nagori Garden, Shastri Nagar, RC Vyas Colony, Gandhi Nagar.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-4 bg-slate-50 rounded-lg">
                                        <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center shrink-0 text-blue-600 font-bold">2</div>
                                        <div>
                                            <h4 className="font-bold text-slate-900">Major Towns</h4>
                                            <p className="text-sm text-slate-600">Raipur, Mohangarh, Mandal, Hamirgarh, Bijolia, Jahazpur.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-4 bg-slate-50 rounded-lg">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-600">Riico Industrial Area, Growth Centre.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="w-full md:w-1/2">
                            ...
                            <p className="text-lg text-slate-600 mb-6">
                                Balaji Pharma is not just a distributor; we are a part of Bhilwara's medical infrastructure. From the bustling markets of <strong>Nagori Garden</strong> to the rural medical centers in <strong>Raipur</strong> and <strong>Mohangarh</strong>, our logistics network ensures that no patient waits for critical medicine.
                            </p>
