        ...
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 bg-brandBlue/20 text-brandBlue px-4 py-1.5 rounded-full text-sm font-medium mb-6 border border-brandBlue/30">
            ...
            <section className="py-16 bg-slate-50">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                        {['Cipla', 'Sun Pharma', 'Glenmark', 'Mankind', 'Alkem', 'Lupin', 'Zydus', 'Abbott'].map(brand => (
                            <Link key={brand} to={`/wholesale-medicines/pharmaceutical-brands/${brand.toLowerCase().replace(/ /g, '-')}-price-list`}
                                className="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center font-medium text-slate-700 hover:text-brandBlue">
                                {brand}
                            </Link>
                        ))}
                    </div>
