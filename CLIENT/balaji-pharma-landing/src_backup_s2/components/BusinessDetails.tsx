      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-24">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 justify-center"
          >
            {details.map((item, index) => (
              <motion.div
                ...
                className="group relative bg-[#0F172A]/80 backdrop-blur-md border border-slate-800 rounded-2xl p-8 hover:bg-[#1E293B] hover:border-brandBlue/50 transition-colors duration-300 hover:shadow-2xl hover:shadow-brandBlue/10 flex flex-col justify-center items-center h-full min-h-[220px]"
              >
          ...
          >
            {services.map((item, index) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -8, transition: { duration: 0.2 } }}
                className="group relative bg-[#0F172A]/80 backdrop-blur-md border border-slate-800 rounded-2xl p-8 hover:bg-[#1E293B] hover:border-emerald-500/50 transition-colors duration-300 hover:shadow-2xl hover:shadow-emerald-500/10 flex flex-col items-center h-full min-h-[280px]"
              >
                {/* Glow effect on hover */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-b from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
